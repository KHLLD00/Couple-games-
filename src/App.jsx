...
import { createRoom, joinRoom, subscribeRoom, resetGame } from './lib/rooms.js'
...
export default function App() {
  ...
  async function handleCreate(name) { setBusy(true); setError(''); try { setRoom(await createRoom(me, name)) } catch (e) { setError(e.message || 'Could not create the room.') } finally { setBusy(false) } }
  ...
  function handleExit() { setRoom(null); setError(''); if (window.location.pathname !== '/') window.history.replaceState({}, '', '/') }
